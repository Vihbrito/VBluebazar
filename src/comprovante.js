...
preloadImages(imagesToPreload, function () {
  document.getElementById("capturar").addEventListener("click", function () {
    // Exibir o alert com a mensagem desejada
    alert("Encaminhar esses dados e o comprovante de PIX e para o número (85) 997229859");

    const elementoParaCapturar = document.getElementById("elemento-para-capturar");
